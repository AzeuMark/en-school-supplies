...
$flag_emoji  = html_entity_decode('&#' . (127397 + ord($flag_code[0])) . ';', ENT_NOQUOTES, 'UTF-8')
  . html_entity_decode('&#' . (127397 + ord($flag_code[1])) . ';', ENT_NOQUOTES, 'UTF-8');
...
if ($role === 'admin') {
    $sidebar_items = [
        ...
        ['key' => 'manage_users',      'label' => 'Manage Users',       'icon' => '👥', 'href' => url('/admin/manage_users/manage_users.php')],
        ['key' => 'pending_accounts',  'label' => 'Pending Accounts',   'icon' => '⏳', 'href' => url('/admin/pending_accounts/pending_accounts.php'), 'badge' => 'pending_accounts'],
        ['key' => 'flagged_users',     'label' => 'Flagged Users',      'icon' => '🚩', 'href' => url('/admin/flagged_users/flagged_users.php')],
        ['key' => 'staff_statistics',  'label' => 'Staff Statistics',   'icon' => '📊', 'href' => url('/admin/staff_statistics/staff_statistics.php')],
    ...
    $sidebar_items = [
        ...
        ['key' => 'pending_accounts', 'label' => 'Pending Accounts', 'icon' => '⏳', 'href' => url('/staff/pending_accounts/pending_accounts.php'), 'badge' => 'pending_accounts'],
    ];
  ...
  <div class="app-shell">
    ...
    <aside class="app-sidebar">
      ...
      <nav>
        ...
        <?php endforeach; ?>
        <a class="sidebar-link <?= $current_page === 'profile' ? 'active' : '' ?>" href="<?= e(url('/' . $role . '/profile/profile.php')) ?>">
          <span class="sl-icon">👤</span>
          <span class="sl-text">Profile</span>
        </a>
      </nav>
    </aside>
    ...
    <header class="app-navbar">
      <button class="nav-hamburger" data-sidebar-toggle aria-label="Toggle sidebar">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M3 12h18M3 18h18"/></svg>
      </button>
      <div class="nav-brand"><span><?= e($store_name) ?></span></div>
      <div class="nav-spacer"></div>

      <span class="nav-time">
        <span class="nav-flag" aria-label="<?= e($flag_label) ?>" title="<?= e($flag_label) ?>"><?= e($flag_emoji) ?></span>
